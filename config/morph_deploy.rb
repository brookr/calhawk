...
set :repository, 'git@github.com:brookr/calhawk.git' # Set here your repository! Example: 'https://www.myrepo.com/myapp/trunk'
...
set :version_name, Time.now.strftime('%Y-%m-%d %H:%M:%S')
...
set :mex_key, "34b09708d70f51279f8e9a960bbd0837db597cc4"
